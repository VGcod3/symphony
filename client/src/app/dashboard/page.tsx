...
export default function Page() {
  return (
    <div className=' bg-neutral-100 flex flex-1 flex-col justify-center px-6 py-6 lg:px-8 gap-4'>
      <DesktopRoomMenu />
      <div className='w-full max-w-7xl mx-auto rounded-md grid-cols-12 md:grid-rows-12 grid gap-4 xl:h-[80vh]'>
