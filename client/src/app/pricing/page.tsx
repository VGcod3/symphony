...
const logos = [
  { name: 'Tuple', url: 'https://tailwindui.com/img/logos/tuple-logo-indigo-200.svg' },
  { name: 'Mirage', url: 'https://tailwindui.com/img/logos/mirage-logo-indigo-200.svg' },
  { name: 'StaticKit', url: 'https://tailwindui.com/img/logos/statickit-logo-indigo-200.svg' },
  { name: 'Transistor', url: 'https://tailwindui.com/img/logos/transistor-logo-indigo-200.svg' },
  { name: 'Workcation', url: 'https://tailwindui.com/img/logos/workcation-logo-indigo-200.svg' },
];
const faqs = [
  {
    id: 1,
